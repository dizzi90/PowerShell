...
namespace System.Management.Automation.Internal
{
    ...
    internal class ClientPowerShellDataStructureHandler
    {
        ...
        {
            int currentState = Interlocked.CompareExchange(ref _connectionState, (Int32)connectionStates.Connected, (Int32)connectionStates.Reconnecting);
        ...
        {
            int currentState = Interlocked.CompareExchange(ref _connectionState, (Int32)connectionStates.Connected, (Int32)connectionStates.Connecting);
        ...
        {
            int currentState = Interlocked.CompareExchange(ref _connectionState, (Int32)connectionStates.Reconnecting, (Int32)connectionStates.Disconnected);
        ...
        {
            int currentState = Interlocked.CompareExchange(ref _connectionState, (Int32)connectionStates.Connecting, (Int32)connectionStates.Disconnected);
        ...
        private int _connectionState = (Int32)connectionStates.Connected;
